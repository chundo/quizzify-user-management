...
export default class EditableTextField extends React.Component {
  ...
  save = (event) => {
    ...
    this.props.onUpdate(this.props.name, this.refs.el.value, this.props.placeholder);
    ...
    if (this.state.isEditing) {
      ...
      return (
        <XEditable isLoading={false} save={this.save} cancel={this.cancel}>
          <input ref='el' id={this.props.id} type='text' className={inputClassName} name={this.props.name} context={this.props.context} defaultValue={this.props.value} placeholder={this.props.placeholder} autoFocus/>
